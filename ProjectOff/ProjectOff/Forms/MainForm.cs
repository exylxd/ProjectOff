    ...
    public partial class MainForm : Form
    {
        ...
        private async void guna2Button1_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(guna2TextBox1.Text, out int seconds))
            {
                ...
                await RunTimerAsync(seconds, selectedAction);
        ...
        private async Task RunTimerAsync(int seconds, string selectedAction)
        {
            ...
            for (int i = seconds; i > 0; i--)
            {
                ...
                guna2ProgressBar1.Value = (int)(((double)(seconds - i) / seconds) * 100);
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            MenuItem showMenuItem = new MenuItem("Открыть ProjectOff", (s, args) => ShowForm());
            MenuItem exitMenuItem = new MenuItem("Выход", (s, args) => Application.Exit());
            ...
            // Добавляем обработчик двойного щелчка по значку в трее
            notifyIcon1.MouseDoubleClick += (s, args) => ShowForm();
        }

        private void ShowForm()
        {
            // Развертываем форму и делаем видимой в панели задач
            this.WindowState = FormWindowState.Normal;
            this.ShowInTaskbar = true;

            // Скрываем значок в трее
        ...
        private void MainForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                // Пользователь закрывает форму, скрываем в трее
                e.Cancel = true;
            ...
            {
                // Другие причины закрытия (например, завершение работы приложения), не скрываем в трее
                notifyIcon1.Dispose();
            }
        }
        ...
        {
            // Отображаем или скрываем значок в трее в зависимости от состояния формы
